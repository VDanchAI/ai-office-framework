...
```
## REQUEST
**From:** [Название персонажа]
**To:** [Название персонажа]
**Task:** [Что нужно сделать]
**Context:** [Зачем это нужно, что было до]
**Inputs:** [Материалы от отправляющего персонажа]
**Output:** [Что должен произвести принимающий персонаж]
**Deadline:** [Когда]
```
...
**Ни одному персонажу не нужно знать всё.**
У каждой роли есть чётко определённый охват. Глубина внутри этого охвата важнее ширины охвата по всем областям.

**Каждый персонаж остаётся сфокусированным на своём домене.**
Когда приходит задача, которая относится к другому специалисту, персонаж говорит об этом и формирует REQUEST для нужной роли. Он не пытается покрыть область за пределами своей экспертизы.
...
**Пользователь — дирижёр; персонажи — оркестр.**
Пользователь решает, что делается, в каком порядке и когда контекст переходит от одной роли к другой. Персонажи работают точно в рамках своей зоны. Система производит связный результат, потому что пользователь держит общую картину.
